import { ArrowRightLeft, RefreshCw, Trash2, Download, Info, Lock, Ban, Diamond, Gem, Circle, Clock, ToggleLeft, ToggleRight, Fingerprint, AlertTriangle, Globe } from 'lucide-react';
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                        ...
                        {account.quota?.restriction_reason ? (
                            <span
                                className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-gradient-to-r from-amber-500 to-orange-500 text-white text-[10px] font-bold shadow-sm cursor-default"
                        ...
                        {account.proxy_id && (() => {
                            ...
                            return proxy ? (
                                <span className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-300 text-[10px] font-bold shadow-sm border border-teal-200/50 dark:border-teal-800/50" title={proxy.url}>
                                    <Globe className="w-2.5 h-2.5" />
                                    {proxy.name || proxy.id}
                                </span>
                            ) : (
                                <span className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-red-100 dark:bg-red-900/40 text-red-600 dark:text-red-400 text-[10px] font-bold shadow-sm border border-red-200/50 dark:border-red-800/50" title={`Proxy ${account.proxy_id} not found`}>
                                    <Globe className="w-2.5 h-2.5" />
                                    ???
                                </span>
                            );
            ...
            <td className="px-4 py-1">
             ...
             <td className="px-4 py-1">
                   <div className="flex items-center gap-0.5 opacity-60 group-hover:opacity-100 transition-opacity">
                      <button
                           type="button"
                           className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-sky-600 dark:hover:text-sky-400 hover:bg-sky-50 dark:bg-sky-900/30 rounded-lg transition-all"
                       ...
                       <button
                           type="button"
                           className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/30 rounded-lg transition-all"
                       ...
                       <button
                           type="button"
                           className={`p-1.5 text-gray-500 dark:text-gray-400 rounded-lg transition-all ${(isRefreshing || isDisabled) ? 'bg-green-50 dark:bg-green-900/10 text-green-600 dark:text-green-400 cursor-not-allowed' : 'hover:text-green-600 dark:text-green-400 hover:bg-green-50 dark:hover:bg-green-900/30'}`}
                      ...
                      <button
                           type="button"
                           className={cn(
                               "p-1.5 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:bg-indigo-900/30 rounded-lg transition-all"
                           )}
                      ...
                      <button
                           ...
                           className={cn(
                               ...
                               account.proxy_disabled
                                   ? "text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 hover:bg-green-50 dark:bg-green-900/30"
                                   : "text-gray-500 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50 dark:bg-orange-50 dark:hover:bg-orange-900/30"
                           )}
                      ...
                      <button
                          type="button"
                          className="p-1.5 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:bg-red-900/30 rounded-lg transition-all"
