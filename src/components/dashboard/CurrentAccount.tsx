                ...
                <div className="flex items-center gap-3 mb-1">
                    ...
                    {account.quota?.restriction_reason ? (
                        ...
                        if (tier.includes('ultra')) {
                            ...
                            return (
                                <span className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-gradient-to-r from-orange-500 to-red-500 text-white text-[10px] font-bold shadow-sm shrink-0">
